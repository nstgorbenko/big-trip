...
/* harmony import */ var _models_destination_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/destination.js */ "./src/models/destination.js");
/* harmony import */ var _models_offer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/offer.js */ "./src/models/offer.js");
/* harmony import */ var _models_trip_event_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/trip-event.js */ "./src/models/trip-event.js");
...
class API {
  ...
  updateTripEvent(id, newData) {
    return this._load({
      ...
      .then(_models_trip_event_js__WEBPACK_IMPORTED_MODULE_2__["default"].parse);
  }
  ...
  _getTripEvents() {
    ...
    .then(API.convertToJson)
    .then(_models_trip_event_js__WEBPACK_IMPORTED_MODULE_2__["default"].parseAll);
  }

  _getDestinations() {
    return this._load({url: Url.DESTINATIONS})
    .then(API.convertToJson)
    .then(_models_destination_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseAll);
  }

  _getOffers() {
    return this._load({url: Url.OFFERS})
    .then(API.convertToJson)
    .then(_models_offer_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseAll);
  }
...
class Provider {
  ...
  getAllData() {
    ...
    const storeTripEvents = _models_trip_event_js__WEBPACK_IMPORTED_MODULE_2__["default"].parseAll(Object.values(this._store.getTripEvents()));
    const storeDestinations = _models_destination_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseAll(this._store.getDestinations());
    const storeOffers = _models_offer_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseAll(this._store.getOffers());
  ...
  createTripEvent(newData) {
    ...
    const storeNewTripEventId = Object(nanoid__WEBPACK_IMPORTED_MODULE_3__["nanoid"])();
    const storeNewTripEvent = _models_trip_event_js__WEBPACK_IMPORTED_MODULE_2__["default"].clone(Object.assign(newData, {id: storeNewTripEventId}));
    ...
    if (isOnline()) {
      ...
      return this._api.sync(storeTripEvents)
        .then((response) => {
          ...
          this._store.setTripEvents(tripItems);
          this._isNeedToSync = false;
          this._tripEventsModel.set(_models_trip_event_js__WEBPACK_IMPORTED_MODULE_2__["default"].parseAll(Object.values(tripItems)));
        });
    }
...
class AbstractComponent {
  ...
  getElement() {
    if (this._element === null) {
      this._element = Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_0__["createElement"])(this.getTemplate());
    }
...
const createDayTemplate = (date, counter = 0) => {
  ...
  return (
    ...
    ${isCertainDay ?
      ...
      <time class="day__date" datetime=${date}>${Object(_utils_date_js__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(date)}</time>` : ``}
      </div>
    </li>`
  );
};
...
class Filter extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(filters = [], activeFilter = _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL) {
    super();
  ...
  setDefault() {
    this._activeType = _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL;
    this.getElement().querySelector(`#filter-${_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL}`).checked = true;
  }
...
const createMenuTemplate = () => {
  return (
    `<nav class="trip-controls__trip-tabs  trip-tabs">
      ...
      <a class="trip-tabs__btn" href="#" data-menu-item="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATS}">Stats</a>
    </nav>`
  );
};
...
class NewEvent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class Sort extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    ...
    this._currenType = _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT;
  }
  ...
  setDefault() {
    this._currenType = _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT;
    this.getElement().querySelector(`#${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}`).checked = true;
  }
  ...
  setChangeHandler(handler) {
    this.getElement().addEventListener(`change`, (evt) => {
      ...
      if (this._currenType === _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME || this._currenType === _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE) {
...
/* harmony import */ var _dict_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../dict.js */ "./src/dict.js");
...
/* harmony import */ var _utils_chart_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/chart.js */ "./src/utils/chart.js");
...
const getEmojiType = (type) => _dict_js__WEBPACK_IMPORTED_MODULE_1__["eventTypeToEmoji"][type] || ``;
...
const renderChart = (chartCtx, chartData, chartTitle, labelView) => {
  ...
  switch (types.length) {
    case 0:
      chartCtx.classList.add(_const_js__WEBPACK_IMPORTED_MODULE_2__["HIDDEN_CLASS"]);
      return null;
    case 1:
  ...
  return Object(_utils_chart_js__WEBPACK_IMPORTED_MODULE_4__["makeChart"])(chartCtx, {
    types,
    values,
    title: chartTitle,
    formatter: labelView,
...
class Statistics extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  update(tripEvents) {
    ...
    const tripTransportEvents = tripEvents.filter(({type}) => _const_js__WEBPACK_IMPORTED_MODULE_2__["TRANSFER_EVENTS"].indexOf(type) > 0);
    ...
    const timeData = getChartData(tripEvents, (tripEvent) => moment__WEBPACK_IMPORTED_MODULE_5___default.a.duration(tripEvent.end - tripEvent.start));
    ...
    this._timeChart = renderChart(timeCtx, timeData, ChartName.TIME, (value) => `${Object(_utils_date_js__WEBPACK_IMPORTED_MODULE_3__["formatDuration"])(value)}`);
  }
...
/* harmony import */ var _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-smart-component.js */ "./src/components/abstract-smart-component.js");
/* harmony import */ var _utils_flatpickr_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/flatpickr.js */ "./src/utils/flatpickr.js");
/* harmony import */ var _utils_common_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/common.js */ "./src/utils/common.js");
/* harmony import */ var _dict_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../dict.js */ "./src/dict.js");
/* harmony import */ var _utils_date_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/date.js */ "./src/utils/date.js");
/* harmony import */ var _utils_dom_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/dom.js */ "./src/utils/dom.js");
...
const getTypeWithPreposition = (type) => _dict_js__WEBPACK_IMPORTED_MODULE_3__["eventTypeToPreposition"].get(type) || ``;
...
const createTripEventEditTemplate = (tripEvent, options = {}) => {
  ...
  const eventGroupsMarkup = createEventGroupsMarkup(_dict_js__WEBPACK_IMPORTED_MODULE_3__["eventGroupToTypes"], type);
  const destinationsMarkup = createDestinationsMarkup(allDestinations);

  const isNewEvent = !id;
  const isStartTime = !!start;
  const startTime = isStartTime ? Object(_utils_date_js__WEBPACK_IMPORTED_MODULE_4__["formatDateToEventEdit"])(start) : ``;
  const isEndTime = !!start;
  const endTime = isEndTime ? Object(_utils_date_js__WEBPACK_IMPORTED_MODULE_4__["formatDateToEventEdit"])(end) : ``;
...
class TripEventEdit extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(tripEvent = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["createNewEvent"])(), destinationsModel = [], offersModel = []) {
    super();
  ...
  setDisabled(value) {
    this.getElement().querySelectorAll(`input, button`)
      .forEach(value ? _utils_dom_js__WEBPACK_IMPORTED_MODULE_5__["setDisabled"] : _utils_dom_js__WEBPACK_IMPORTED_MODULE_5__["unsetDisabled"]);
  }
  ...
  _applyFlatpickr() {
    ...
    this._startFlatpickr = Object(_utils_flatpickr_js__WEBPACK_IMPORTED_MODULE_1__["createFlatpickr"])(startTime, {
    ...
    this._endFlatpickr = Object(_utils_flatpickr_js__WEBPACK_IMPORTED_MODULE_1__["createFlatpickr"])(endTime, {
...
/* harmony import */ var _dict_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../dict.js */ "./src/dict.js");
/* harmony import */ var _utils_date_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/date.js */ "./src/utils/date.js");
...
const createTripEventTemplate = (tripEvent) => {
  ...
  const startTime = Object(_utils_date_js__WEBPACK_IMPORTED_MODULE_3__["formatTime"])(start);
  const endTime = Object(_utils_date_js__WEBPACK_IMPORTED_MODULE_3__["formatTime"])(end);
  const duration = Object(_utils_date_js__WEBPACK_IMPORTED_MODULE_3__["formatDuration"])(end, start);
  ...
  return (
    `<li class="trip-events__item">
      <div class="event">
        ...
        <h3 class="event__title">${_dict_js__WEBPACK_IMPORTED_MODULE_2__["eventTypeToPreposition"].get(type)} ${destination.name}</h3>
...
class TripEvent extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(tripEvent = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["createNewEvent"])()) {
    super();
...
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
/* harmony import */ var _utils_date_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/date.js */ "./src/utils/date.js");
/* harmony import */ var _utils_cost_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/cost.js */ "./src/utils/cost.js");
...
const getTripDates = (sortedTripEvents) => {
  ...
  const firstEventDate = Object(_utils_date_js__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(firstEvent.start);

  const lastEvent = getLastItem(sortedTripEvents);
  const lastEventDate = Object(_utils_date_js__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(lastEvent.end);
...
class TripInfo extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  update(tripEvents) {
    const sortedTripEvents = Object(_utils_sort_js__WEBPACK_IMPORTED_MODULE_3__["getSortedTripEvents"])(tripEvents, _const_js__WEBPACK_IMPORTED_MODULE_4__["SortType"].DEFAULT);

    this._title = getTripTitle(sortedTripEvents);
    this._dates = getTripDates(sortedTripEvents);
    this._cost = Object(_utils_cost_js__WEBPACK_IMPORTED_MODULE_2__["getTotalCost"])(tripEvents);
...
/***/ "./src/components/trip-message.js":
/*!****************************************!*\
  !*** ./src/components/trip-message.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripMessage; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class TripMessage extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(message = ``) {
    super();
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: ActionType, DeleteButtonText, FilterType, HIDDEN_CLASS, MenuItem, Message, Mode, RenderPosition, SortType, SubmitButtonText, TRANSFER_EVENTS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SubmitButtonText", function() { return SubmitButtonText; });
...
class FilterController {
  ...
  render() {
    ...
    const activeFilter = this._filterComponent === null ? _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL : this._filterComponent.getActiveType();

    const filters = Object.values(_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"]).map((filterType) => {
      return {
        name: filterType,
        isEnabled: Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["checkEnabledFilter"])(allEvents, filterType),
        isChecked: filterType === activeFilter,
      };
    });

    const oldFilterComponent = this._filterComponent;
    this._filterComponent = new _components_filter_js__WEBPACK_IMPORTED_MODULE_0__["default"](filters, activeFilter);
    this._filterComponent.setChangeHandler(this._filterChangeHandler);

    if (oldFilterComponent !== null) {
      Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._filterComponent, oldFilterComponent);
      Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(oldFilterComponent);
    } else {
      Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_2__["render"])(container, this._filterComponent);
    }
  }

  setDefault() {
    this._filterComponent.setDefault();
    this._tripEventsModel.setFilter(_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL);
  }
...
class StatisticsController {
  ...
  _render() {
    ...
    this._statisticsComponent = new _components_statistics_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._statisticsComponent.update(tripEvents);

    if (oldStatisticsComponent !== null) {
      Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._statisticsComponent, oldStatisticsComponent);
      Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(oldStatisticsComponent);
    } else {
      Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._statisticsComponent, _const_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].AFTEREND);
    }
  }
...
/* harmony import */ var _components_events_list_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/events-list.js */ "./src/components/events-list.js");
...
/* harmony import */ var _components_trip_days_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/trip-days.js */ "./src/components/trip-days.js");
/* harmony import */ var _trip_event_controller_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./trip-event-controller.js */ "./src/controllers/trip-event-controller.js");
/* harmony import */ var _components_trip_message_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/trip-message.js */ "./src/components/trip-message.js");
...
/* harmony import */ var _utils_dom_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/dom.js */ "./src/utils/dom.js");
...
const groupEventsByDays = (someEvents) => {
  return someEvents.reduce((days, currentDay) => {
    const someDate = Object(_utils_date_js__WEBPACK_IMPORTED_MODULE_6__["formatDateToDayDatetime"])(currentDay.start);
...
class TripController {
  constructor(container, tripEventsModel, destinationsModel, offersModel, api, newEventComponent) {
    ...
    this._tripDaysComponent = new _components_trip_days_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
  ...
  render() {
    ...
    if (this._tripEventsModel.isEmpty()) {
      this._renderTripMessage(_const_js__WEBPACK_IMPORTED_MODULE_8__["Message"].NO_EVENTS);
      return;
    }
  ...
  createEvent() {
    ...
    if (this._tripEventsModel.isEmpty()) {
      ...
      this._renderNewEvent(this._container, _const_js__WEBPACK_IMPORTED_MODULE_8__["Mode"].FIRST);
    } else {
      this._setDefaultViews();
      this._renderNewEvent(this._tripDaysComponent.getElement(), _const_js__WEBPACK_IMPORTED_MODULE_8__["Mode"].ADD);
    }
  }
  ...
  showLoadingMessage() {
    this._renderTripMessage(_const_js__WEBPACK_IMPORTED_MODULE_8__["Message"].LOADING);
  }

  showErrorMessage() {
    this._renderTripMessage(_const_js__WEBPACK_IMPORTED_MODULE_8__["Message"].ERROR);
  }
  ...
  _renderFirstBoard(tripEvents) {
    ...
    Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._container, this._sortComponent);
    Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._container, this._tripDaysComponent);

    const tripDays = this._tripDaysComponent.getElement();
    this._showedTripEvents = this._renderSortedTripEvents(_const_js__WEBPACK_IMPORTED_MODULE_8__["SortType"].DEFAULT, tripDays, tripEvents);
  }

  _renderNewEvent(container, mode) {
    this._newEvent = new _trip_event_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](container, this._destinationsModel, this._offersModel, this._dispatch);
    this._newEvent.render(Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_9__["createNewEvent"])(), mode);
  }

  _renderTripMessage(message) {
    this._removeTripMessage();
    this._tripMessageComponent = new _components_trip_message_js__WEBPACK_IMPORTED_MODULE_5__["default"](message);
    Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._container, this._tripMessageComponent);
  }

  _removeTripMessage() {
    if (this._tripMessageComponent !== null) {
      Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._tripMessageComponent);
    }
  }

  _removeFirstBoard() {
    this._removeEvents();
    Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._sortComponent);
    Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._tripDaysComponent);
    this._renderTripMessage(_const_js__WEBPACK_IMPORTED_MODULE_8__["Message"].NO_EVENTS);
  }
  ...
  _updateEvents(sortType) {
    ...
    let newSortType = _const_js__WEBPACK_IMPORTED_MODULE_8__["SortType"].DEFAULT;
    if (this._newEvent === null) {
  ...
  _renderTripEvents(container, tripEvents) {
    return tripEvents.map((tripEvent) => {
      const tripEventController = new _trip_event_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](container, this._destinationsModel, this._offersModel, this._dispatch);
  ...
  _renderGroupedEvents(container, groupedEvents) {
    ...
    for (let i = 0; i < days.length; i++) {
      ...
      const dayComponent = new _components_day_js__WEBPACK_IMPORTED_MODULE_0__["default"](day, dayCounter);
      const eventsListComponent = new _components_events_list_js__WEBPACK_IMPORTED_MODULE_1__["default"]();

      for (const tripEvent of groupedEvents[day]) {
        const tripEventController = new _trip_event_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](eventsListComponent.getElement(), this._destinationsModel, this._offersModel, this._dispatch);
        tripEventController.render(tripEvent);
        eventControllers.push(tripEventController);
      }

      Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_10__["render"])(dayComponent.getElement(), eventsListComponent);
      Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_10__["render"])(container, dayComponent);
    }
  ...
  _renderSortedTripEvents(sortType, container, tripEvents) {
    const sortedTripEvents = Object(_utils_sort_js__WEBPACK_IMPORTED_MODULE_7__["getSortedTripEvents"])(tripEvents, sortType);

    if (sortType === _const_js__WEBPACK_IMPORTED_MODULE_8__["SortType"].DEFAULT) {
      return this._renderAllEvents(container, sortedTripEvents);
    }

    const dayComponent = new _components_day_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    const eventsListComponent = new _components_events_list_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
  ...
  _handleAddToFavoriteAction({payload}) {
    this._api.updateTripEvent(payload.id, payload.newData)
      .then((tripEvent) => {
        ...
        if (isSuccess) {
          payload.controller.render(tripEvent, _const_js__WEBPACK_IMPORTED_MODULE_8__["Mode"].EDIT);
        }
      });
  }
  ...
  _dispatch(action) {
    switch (action.type) {
      case _const_js__WEBPACK_IMPORTED_MODULE_8__["ActionType"].ADD_TO_FAVORITE:
        this._handleAddToFavoriteAction(action);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_8__["ActionType"].DELETE:
        this._handleDeleteAction(action);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_8__["ActionType"].ADD_NEW_EVENT:
        this._handleAddNewEventAction(action);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_8__["ActionType"].REMOVE_NEW_EVENT:
        this._handleRemoveNewEventAction();
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_8__["ActionType"].TO_EDIT:
        this._handleToEditAction();
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_8__["ActionType"].UPDATE:
...
/***/ "./src/controllers/trip-event-controller.js":
/*!**************************************************!*\
  !*** ./src/controllers/trip-event-controller.js ***!
  \**************************************************/
/*! exports provided: default */
...
/* harmony import */ var _models_trip_event_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/trip-event.js */ "./src/models/trip-event.js");
...
/* harmony import */ var _components_trip_event_edit_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/trip-event-edit.js */ "./src/components/trip-event-edit.js");
...
class TripEventController {
  ...
  render(tripEvent, mode = _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].DEFAULT) {
    this._mode = mode;

    const oldTripEventComponent = this._tripEventComponent;
    const oldTripEventEditComponent = this._tripEventEditComponent;

    this._tripEventComponent = new _components_trip_event_js__WEBPACK_IMPORTED_MODULE_1__["default"](tripEvent);
    this._tripEventEditComponent = new _components_trip_event_edit_js__WEBPACK_IMPORTED_MODULE_2__["default"](tripEvent, this._destinationsModel, this._offersModel);
    ...
    switch (mode) {
      case _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].DEFAULT:
        if (oldTripEventComponent !== null && oldTripEventEditComponent !== null) {
          ...
          Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._container, this._tripEventComponent);
        }
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].EDIT:
        this._replaceOldEventComponents(oldTripEventComponent, oldTripEventEditComponent);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].FIRST:
        document.addEventListener(`keydown`, this._escKeyDownHandler);
        Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._container, this._tripEventEditComponent);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].ADD:
        document.addEventListener(`keydown`, this._escKeyDownHandler);
        Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._container, this._tripEventEditComponent, _const_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREBEGIN);
        break;
    }
  }

  destroy() {
    Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._tripEventComponent);
    Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._tripEventEditComponent);
  ...
  shake() {
    ...
    setTimeout(() => {
      ...
      this._tripEventEditComponent.setSubmitButtonText(_const_js__WEBPACK_IMPORTED_MODULE_3__["SubmitButtonText"].DEFAULT);
      if (this._mode === _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].EDIT) {
        this._tripEventEditComponent.setDeleteButtonText(_const_js__WEBPACK_IMPORTED_MODULE_3__["DeleteButtonText"].DEFAULT);
      }
  ...
  _replaceDefaultToEdit() {
    this._dispatch({
      type: _const_js__WEBPACK_IMPORTED_MODULE_3__["ActionType"].TO_EDIT,
    });
    this._tripEventEditComponent.reset();
    Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._tripEventEditComponent, this._tripEventComponent);
    document.addEventListener(`keydown`, this._escKeyDownHandler);
    this._mode = _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].EDIT;
  }

  _replaceEditToDefault() {
    Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._tripEventComponent, this._tripEventEditComponent);
    document.removeEventListener(`keydown`, this._escKeyDownHandler);
    this._mode = _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].DEFAULT;
  }

  _replaceOldEventComponents(oldTripEventComponent, oldTripEventEditComponent) {
    Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._tripEventComponent, oldTripEventComponent);
    Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._tripEventEditComponent, oldTripEventEditComponent);
    Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(oldTripEventComponent);
    Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(oldTripEventEditComponent);
  }
  ...
  _subscribeOnEvents(tripEvent) {
    ...
    this._tripEventEditComponent.setSubmitHandler(() => {
      ...
      const newTripEvent = _models_trip_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].parse(formData);

      this._tripEventEditComponent.setDisabled(true);
      this._tripEventEditComponent.setSubmitButtonText(_const_js__WEBPACK_IMPORTED_MODULE_3__["SubmitButtonText"].PENDING);

      this._dispatch({
        type: this._mode === _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].EDIT ? _const_js__WEBPACK_IMPORTED_MODULE_3__["ActionType"].UPDATE : _const_js__WEBPACK_IMPORTED_MODULE_3__["ActionType"].ADD_NEW_EVENT,
        payload: {
          id: tripEvent.id,
          controller: this,
    ...
    this._tripEventEditComponent.setFavoriteButtonClickHandler(() => {
      const newTripEvent = _models_trip_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].clone(tripEvent);
      newTripEvent.isFavorite = !newTripEvent.isFavorite;

      this._dispatch({
        type: _const_js__WEBPACK_IMPORTED_MODULE_3__["ActionType"].ADD_TO_FAVORITE,
        payload: {
          id: tripEvent.id,
          controller: this,
          newData: newTripEvent
    ...
    this._tripEventEditComponent.setDeleteButtonClickHandler(() => {
      if (this._mode === _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].EDIT) {
        this._tripEventEditComponent.setDisabled(true);
        this._tripEventEditComponent.setDeleteButtonText(_const_js__WEBPACK_IMPORTED_MODULE_3__["DeleteButtonText"].PENDING);
      }

      this._dispatch({
        type: this._mode === _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].EDIT ? _const_js__WEBPACK_IMPORTED_MODULE_3__["ActionType"].DELETE : _const_js__WEBPACK_IMPORTED_MODULE_3__["ActionType"].REMOVE_NEW_EVENT,
        payload: {
          id: tripEvent.id,
          controller: this
        }
  ...
  _escKeyDownHandler(evt) {
    if (Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_4__["isEscKey"])(evt)) {
      if (this._mode === _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].ADD || this._mode === _const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].FIRST) {
        this._dispatch({
          type: _const_js__WEBPACK_IMPORTED_MODULE_3__["ActionType"].REMOVE_NEW_EVENT,
        });
        return;
      }
      this._replaceEditToDefault();
...
/***/ "./src/controllers/trip-info-controller.js":
/*!*************************************************!*\
  !*** ./src/controllers/trip-info-controller.js ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripInfoController; });
...
class TripInfoController {
  ...
  render() {
    ...
    this._tripInfoComponent = new _components_trip_info_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._tripInfoComponent.update(tripEvents);

    if (oldTripInfoComponent !== null) {
      Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._tripInfoComponent, oldTripInfoComponent);
      Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(oldTripInfoComponent);
    } else {
      Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_1__["render"])(container, this._tripInfoComponent, _const_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].AFTERBEGIN);
    }
  }
...
/*!*********************!*\
  !*** ./src/dict.js ***!
  \*********************/
/*! exports provided: eventGroupToTypes, eventTypeToPreposition, eventTypeToEmoji */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "eventGroupToTypes", function() { return eventGroupToTypes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "eventTypeToPreposition", function() { return eventTypeToPreposition; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "eventTypeToEmoji", function() { return eventTypeToEmoji; });
const eventGroupToTypes = {
  'Transfer': [`Taxi`, `Bus`, `Train`, `Ship`, `Transport`, `Drive`, `Flight`],
  'Activity': [`Check-in`, `Sightseeing`, `Restaurant`],
};

const eventTypeToPreposition = new Map([
  [`taxi`, `Taxi to`],
  [`bus`, `Bus to`],
  [`train`, `Train to`],
  [`ship`, `Ship to`],
...
/* harmony import */ var _models_destinations_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/destinations.js */ "./src/models/destinations.js");
/* harmony import */ var _controllers_filter_controller_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controllers/filter-controller.js */ "./src/controllers/filter-controller.js");
...
/* harmony import */ var _components_new_event_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/new-event.js */ "./src/components/new-event.js");
/* harmony import */ var _models_offers_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./models/offers.js */ "./src/models/offers.js");
/* harmony import */ var _api_provider_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./api/provider.js */ "./src/api/provider.js");
/* harmony import */ var _controllers_statistics_controller_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./controllers/statistics-controller.js */ "./src/controllers/statistics-controller.js");
/* harmony import */ var _api_store_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./api/store.js */ "./src/api/store.js");
/* harmony import */ var _controllers_trip_controller_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./controllers/trip-controller.js */ "./src/controllers/trip-controller.js");
/* harmony import */ var _models_trip_events_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./models/trip-events.js */ "./src/models/trip-events.js");
/* harmony import */ var _controllers_trip_info_controller_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./controllers/trip-info-controller.js */ "./src/controllers/trip-info-controller.js");
/* harmony import */ var _utils_dom_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./utils/dom.js */ "./src/utils/dom.js");
...
const tripEventsModel = new _models_trip_events_js__WEBPACK_IMPORTED_MODULE_10__["default"]();
const destinationsModel = new _models_destinations_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
const offersModel = new _models_offers_js__WEBPACK_IMPORTED_MODULE_5__["default"]();

const api = new _api_api_js__WEBPACK_IMPORTED_MODULE_0__["default"](END_POINT, AUTHORIZATION);
const store = new _api_store_js__WEBPACK_IMPORTED_MODULE_8__["default"](window.localStorage);
const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_6__["default"](api, store, tripEventsModel);

const menuComponent = new _components_menu_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
const newEventComponent = new _components_new_event_js__WEBPACK_IMPORTED_MODULE_4__["default"]();

const statisticsController = new _controllers_statistics_controller_js__WEBPACK_IMPORTED_MODULE_7__["default"](tripBoard, tripEventsModel);
const tripInfoController = new _controllers_trip_info_controller_js__WEBPACK_IMPORTED_MODULE_11__["default"](tripMain, tripEventsModel);
const filterController = new _controllers_filter_controller_js__WEBPACK_IMPORTED_MODULE_2__["default"](tripControls, tripEventsModel);
const tripController = new _controllers_trip_controller_js__WEBPACK_IMPORTED_MODULE_9__["default"](tripBoard, tripEventsModel, destinationsModel, offersModel, apiWithProvider, newEventComponent);
...
Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_12__["render"])(tripMain, newEventComponent);
Object(_utils_dom_js__WEBPACK_IMPORTED_MODULE_12__["render"])(tripViewHeading, menuComponent, _const_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].AFTEREND);

newEventComponent.setClickHandler(newEventClickHandler);
menuComponent.setChangeHandler((menuItem) => {
  switch (menuItem) {
    case _const_js__WEBPACK_IMPORTED_MODULE_13__["MenuItem"].TABLE:
      showTable();
      break;
    case _const_js__WEBPACK_IMPORTED_MODULE_13__["MenuItem"].STATS:
      showStats();
      break;
  }
});
...
/*!****************************!*\
  !*** ./src/utils/chart.js ***!
  \****************************/
/*! exports provided: makeChart */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeChart", function() { return makeChart; });
...
const makeChart = (element, options = {}) =>
  new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(element, makeOptions(options));
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: addZero, createNewEvent, isEscKey */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!***************************!*\
  !*** ./src/utils/cost.js ***!
  \***************************/
/*! exports provided: getTotalCost */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTotalCost", function() { return getTotalCost; });
...
/*!***************************!*\
  !*** ./src/utils/date.js ***!
  \***************************/
/*! exports provided: formatDateToDayDatetime, formatDateToEventEdit, formatDate, formatTime, formatDuration */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatDateToDayDatetime", function() { return formatDateToDayDatetime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatDateToEventEdit", function() { return formatDateToEventEdit; });
...
const formatDateToDayDatetime = (date) => moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`YYYY-MM-DD`);

const formatDateToEventEdit = (date) => moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`DD/MM/YY HH:mm`);

const formatDate = (date) => moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`DD MMM`);

const formatTime = (date) => moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`HH:mm`);

const formatDuration = (endTime, startTime = 0) => {
  const {days, hours, minutes} = Object(moment__WEBPACK_IMPORTED_MODULE_1__["duration"])(endTime - startTime)._data;

  if (days > 0) {
    return `${Object(_common_js__WEBPACK_IMPORTED_MODULE_0__["addZero"])(days)}D ${Object(_common_js__WEBPACK_IMPORTED_MODULE_0__["addZero"])(hours)}H ${Object(_common_js__WEBPACK_IMPORTED_MODULE_0__["addZero"])(minutes)}M`;
  }
  if (hours > 0) {
    return `${Object(_common_js__WEBPACK_IMPORTED_MODULE_0__["addZero"])(hours)}H ${Object(_common_js__WEBPACK_IMPORTED_MODULE_0__["addZero"])(minutes)}M`;
  }

  return minutes > 0 ? `${Object(_common_js__WEBPACK_IMPORTED_MODULE_0__["addZero"])(minutes)}M` : ``;
};
...
/*!**************************!*\
  !*** ./src/utils/dom.js ***!
  \**************************/
/*! exports provided: createElement, remove, render, replace, setDisabled, unsetDisabled */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "unsetDisabled", function() { return unsetDisabled; });
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
...
const render = (container, component, place = _const_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND) => {
  switch (place) {
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: getEventsByFilter, checkEnabledFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getEventsByFilter", function() { return getEventsByFilter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkEnabledFilter", function() { return checkEnabledFilter; });
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
...
const getEventsByFilter = (tripEvents, filterType) => {
  switch (filterType) {
...
const checkEnabledFilter = (tripEvents, filterType) => {
  switch (filterType) {
    case _const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL:
...
/*!********************************!*\
  !*** ./src/utils/flatpickr.js ***!
  \********************************/
/*! exports provided: createFlatpickr */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createFlatpickr", function() { return createFlatpickr; });
...
const createFlatpickr = (element, options = {}) =>
  flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(element, Object.assign({}, defaultConfiguration, options));
